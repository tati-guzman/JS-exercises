...
let dreamDestination = "New Zealand";
...
// num2 but not num1?
// num1 and num2 have similar ranges of 1-10 but num 1 is not inclusive of its min and max meaning that 1 and 10 are not valid numbers for num1 but they are included as options for num2.
// To write these ranges out, it would look something like this: num1 > 1 && num1 < 10; num2 >= 1 && num2 <= 10
...
//I found this relatively easy! Once I was done, I looked at the notes I had taken from freeCodeCamp to double check my understanding of NaN. 
//The biggest hurdle was making sure I understood Exercise 5 correctly (in that I should just pick a number rather than provide the range) and deciding if answers to exercises 17-22 should stay as strings or not. I answered as a string to follow the example set in the directions.
